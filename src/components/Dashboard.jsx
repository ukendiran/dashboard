...
import Table from "../apexchart/Table";
            ...
            <div className="card shadow p-3 bg-white rounded">
              <div className="card-body">
                <div className="card-title">
                  ...
                  <Table categories={["China", "France", "South Africa"]} series={series} />
            ...
            <div className="card shadow p-3 bg-white rounded">
              <div className="card-body">
                <div className="card-title">
                  ...
                  <Table categories={["First Name", "Cost Reference ID", "Position Reference ID", "Pay Group Reference ID"]} series={series1} />
